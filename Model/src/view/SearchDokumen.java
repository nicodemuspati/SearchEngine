 ...
 * @author AxYxA
 */
public class SearchDokumen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TabelkuSearch = new javax.swing.JTable();
        ...
        jScrollPane1.setViewportView(TabelkuSearch);
        ...
        jLabel1.setText("Masukkan Query : ");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(SearchQuery, javax.swing.GroupLayout.DEFAULT_SIZE, 232, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void SearchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchButtonActionPerformed
        for (int i = 0; i < TabelkuSearch.getRowCount(); i++) {
            TabelkuSearch.setValueAt("", i, 0);
            TabelkuSearch.setValueAt("", i, 1);
        }
        ...
        for (int i = 0; i < listDocs.size(); i++) {
            ...
            if (Home.getIndex().getCosineSimilarity(queryPostingList, PostingDokumen) > 0) {
                TabelkuSearch.setValueAt(listDocs.get(i).getId(), x, 0);
                TabelkuSearch.setValueAt(listDocs.get(i).getNamaDokumen(), x, 1);
                x++;
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchDokumen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchDokumen().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable TabelkuSearch;
